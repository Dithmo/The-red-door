...
| `docs/WALKTHROUGH.md` | the 160-command winning route, generated by playing the game |
...
| `tools/build_walkthrough.mjs` | plays the winning route and writes `docs/WALKTHROUGH.md` |
...
Full walkthrough in `docs/WALKTHROUGH.md`; dependency graph and puzzle analysis
in `docs/GAME-DATA.md` §6.
